...
export abstract class DataSource {
  ...
  protected onInitializedSource = new Subject<any>();
  ...
  onInitialized(): Observable<any> {
    return this.onInitializedSource.asObservable();
  }
  ...
  emitOnInitialized(finished: any) {
    this.onInitializedSource.next(finished);
  }
}
