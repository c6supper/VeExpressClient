...
export class ServerDataSource extends LocalDataSource {
  ...
  private customHttpParas: HttpParams;
  ...
  constructor(
    ...
    this.customHttpParas = customHttpParas;
  ...
  protected createRequestParams(): HttpParams {
    ...
    httpParams = this.addCustomRequestParams(httpParams);
  ...
  protected addCustomRequestParams(httpParams: HttpParams): HttpParams {
    if (!!this.customHttpParas) {
      this.customHttpParas.keys().forEach((para) => {
        httpParams = httpParams.append(para, this.customHttpParas.get(para));
      });
    }
    return httpParams;
  }
  ...
  protected getDeepFromObject(object = {}, name: string, defaultValue?: any) {
    return getDeepFromObject(object, name, defaultValue);
  }
}
